...
public class Extentreporter {
	...
	static String reportsFolder=d.toString().replaceAll(":", "-") +"//screenshots";
	public static String screenshotFolderPath = System.getProperty("user.dir") +"//reports//"+reportsFolder;
